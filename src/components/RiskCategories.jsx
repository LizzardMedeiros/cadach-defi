          ...
          {categories.map((category) => {
            ...
            return (
              ...
              >
                ...
                {/* CTA Button */}
                <Button 
                  className={`w-full bg-gradient-to-r ${category.gradient} hover:opacity-90 text-white font-semibold py-3 rounded-lg transition-all duration-300`}
                  onClick={(e) => {
                    e.stopPropagation()
                ...
                {/* Expanded content */}
                {isSelected && (
                  <div className="absolute top-full left-0 right-0 bg-white rounded-b-2xl shadow-xl p-6 z-10 border-t">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                          Esta categoria é ideal para investidores que buscam {category.name.toLowerCase()} 
                          e estão dispostos a aceitar os riscos correspondentes em troca dos retornos esperados.
                        </p>
